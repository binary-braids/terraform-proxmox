...
variable "dc02_startup_order" {
  description = "The startup order for the VM"
  type        = number
}

variable "dc02_startup_delay" {
...
variable "dc02_efi_disk_file_format" {
